        ...
        <div class="flex flex-col justify-between bg-white rounded-lg shadow-lg p-4">
            <h3 class="font-medium leading-tight text-3xl mt-0 mb-4 text-sky-600">Your Progress</h3>
             <div class="my-4 border-b-2  border-b-gray-400 pb-10"> 
                    ...
                    <div class="flex">
                        <div class="flex mb-4 text-sm w-full justify-end max-w-max cursor-pointer md:mx-0 group">
                        ...
                        <span class="text-sm font-medium m-1 text-green-500 dark:text-white">{{this.credits}}/125 <span class="font-medium text-gray-600">(min. 125)</span>
                        </span>
                    </div>
