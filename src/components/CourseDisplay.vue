<template>
    ...
    <div class=" lg:ml-[30%] flex w-full overflow-y-auto h-fit justify-center " v-if="highlightedModule !== null">
        <div class=" flex flex-col justify-center items-center my-4 " v-for="p in this.getModule()" :key="p.id">
            ...
            <div class="grid grid-col-1 grid-rows-2 xl:grid-cols-2 xl:grid-rows-1 gap-4 mx-4 xl:h-[600px] mb-[69px]">
                ...
                <div class=" xl:h-full bg-white rounded-lg shadow-xl mx-auto flex flex-col px-7 py-3 xl:overflow-y-auto row-start-1 row-end-3 xl:row-end-1 ">
                    ...
                    <h5 class="font-medium leading-tight text-lg sm:text-xl mt-0 mb-2 text-amber-600">Course Coordinator(s)</h5>
                     <ul class="list-disc">
                        <li class="text-sm sm:text-base ml-6" v-for="(o, index) in p.description.course_coordinator" :key="index">
                            {{o}}
                        </li>
                    </ul>
                    <h5 class="font-medium leading-tight text-xl mt-0 mb-2 text-amber-600 pt-3">Pre-requisites</h5>
                    <ul class="list-disc">
                        <li class="text-sm sm:text-base ml-6" v-for="(o, index) in p.description.pre_requisites" :key="index">
                            {{o}}
                        </li>
                    </ul>
                    <h5 class="font-medium leading-tight text-xl mt-0 mb-2 text-amber-600 pt-3">Co-requisites</h5>
                    <ul class="list-disc">
                        <li class="text-sm sm:text-base ml-6" v-for="(o, index) in p.description.co_requisites" :key="index">
                            {{o}}
                        </li>
                    </ul>
                    <h5 class="font-medium leading-tight text-xl mt-0 mb-2 text-amber-600 pt-3">Recommended</h5>
                     <ul class="list-disc">
                        <li class="text-sm sm:text-base ml-6" v-for="(o, index) in p.description.recommended" :key="index">
                            {{o}}
                        </li>
                    </ul>
                    <h5 class="font-medium leading-tight text-xl mt-0 mb-2 text-amber-600 pt-3">Objectives</h5>
                    <ul class="list-disc">
                        <li class="text-sm sm:text-base ml-6 text-justify" v-for="(o, index) in p.description.objectives" :key="index">
                            {{o}}
                        </li>
                    </ul>
                    <h5 class="font-medium leading-tight text-xl mt-0 mb-2 text-amber-600 pt-3">Literature</h5>
                    <ul class="list-disc">
                        <li class="text-sm sm:text-base ml-6 text-justify" v-for="(o, index) in p.description.literature" :key="index">
                            {{o}}
                        </li>
                    </ul>
                    <h5 class="font-medium leading-tight text-xl mt-0 mb-2 text-amber-600 pt-3">Format</h5>
                    <ul>
                        <li class="text-sm sm:text-base ml-6">
                            {{p.description.format}}
                        </li>
                    </ul>
                    <h5 class="font-medium leading-tight text-xl mt-0 mb-2 text-amber-600 pt-3">Assessment</h5>
                    <ul class="list-disc">
                        <li class="text-sm sm:text-base ml-6" v-for="(o, index) in p.description.assessment" :key="index">
                            {{o}}
                        </li>
                    </ul>
                </div>
