<template>
    ...
    <div class="relative ml-1">
        ...
        <input type="search" id="default-search" v-model="searchTerm"  class="block p-4 pl-4 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-sky-500 focus:border-sky-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" placeholder="Search Modules" required>
...
<ul  >
<div v-if="searchTerm !== ''" class="absolute h-96 bg-white rounded-lg shadow-2xl border-gray-600 overflow-auto">
